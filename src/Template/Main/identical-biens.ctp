    ...
    <div class="row">
        <div class="col-lg-4 col-sm-3">
            <?php if(count($identical->images) > 0): ?>
                <?= $this->Html->image('/img/biens/' . $identical->images[0]->name, ["class" => "img-responsive img-circle"]); ?>
                <?php else: ?>
                <?= $this->Html->image('/img/template/default-house.png', ["class" => "img-responsive img-circle"]); ?>
            <?php endif; ?>
        </div>
