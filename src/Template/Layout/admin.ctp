...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/admin/biens/" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>J</b>GL</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Jungle</b>Administration</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-right">
                                    <a href="/admin/users/logout" class="btn btn-default btn-flat">Se déconnecter</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">Jungle Immobilier</a>.</strong>.
    </footer>
