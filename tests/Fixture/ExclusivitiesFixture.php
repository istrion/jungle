...
/**
 * ExclusivitiesFixture
 *
 */
class ExclusivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'telephone' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
